...
const query = graphql`
  {
    file(relativePath: { eq: "uskela_kartta.png" }) {
      childImageSharp {
        fluid {
      ...
      <div className="section-center about-center">
        <article className="about-text">
          ...
          <p className="hakemuspainike">
            <button className="button hakemuspainike">
          ...
          <div className="about-stack">
            {/* <p><button className="button"><a href={downloadFile}> <span className="linkki">Uskelan kartta ja stipendihakemus</span> </a></button></p> */}
