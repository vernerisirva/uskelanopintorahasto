      ...
      <div className="section-center about-center">
        <article className="about-text">
          ...
          <p>
            ...
            alueella hyödyntäen yllä olevaa kaupungin karttaa. Vanha Salon alue eivätkä vanhat
            ympäryskunnat kuten Halikko, Pertteli ja Muurla kuulu Uskelan
            alueeseen. Painamalla "suurenna karttaa" pääset kaupungin
            karttapalveluun, jossa voit katsoa oman osoitteesi sijainnin
            kartalla.
          </p>
          <p>
